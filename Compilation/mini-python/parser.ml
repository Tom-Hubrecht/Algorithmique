...
# 223 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( x :: xs )
# 120 "parser.ml"
         in
...
and _menhir_goto_stmt : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_stmt -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | END | EOF ->
        ...
        let _v : 'tv_nonempty_list_stmt_ = 
# 221 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( [ x ] )
# 245 "parser.ml"
         in
...
# 351 "parser.ml"
    ...
    | MenhirState10 ->
        ...
        ((let ((((_menhir_stack, _menhir_s), _, (f : 'tv_ident)), _, (xs : 'tv_loption_separated_nonempty_list_COMMA_ident__)), _, (s : 'tv_suite)) = _menhir_stack in
        let _6 = () in
        let _5 = () in
        let _3 = () in
        let _1 = () in
        let _v : 'tv_def = let x = 
# 232 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( xs )
# 367 "parser.ml"
         in
...
# 144 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( x )
# 483 "parser.ml"
         in
...
# 243 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( x :: xs )
# 500 "parser.ml"
         in
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState18 ->
        ...
        | RP ->
            ...
            ((let ((_menhir_stack, _menhir_s, (f : 'tv_ident)), _, (xs : 'tv_loption_separated_nonempty_list_COMMA_expr__)) = _menhir_stack in
            let _4 = () in
            let _2 = () in
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState14 | MenhirState42 | MenhirState18 ->
        ...
        | RP | RSQ ->
            ...
            ((let (_menhir_stack, _menhir_s, (x : 'tv_expr)) = _menhir_stack in
            let _v : 'tv_separated_nonempty_list_COMMA_expr_ = 
# 241 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( [ x ] )
# 839 "parser.ml"
             in
...
and _menhir_reduce22 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : 'tv_loption_separated_nonempty_list_COMMA_expr__ = 
# 142 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( [] )
# 1736 "parser.ml"
     in
...
and _menhir_goto_list_def_ : _menhir_env -> 'ttv_tail -> _menhir_state -> 'tv_list_def_ -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState94 ->
        ...
        let _v : 'tv_list_def_ = 
# 213 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( x :: xs )
# 2176 "parser.ml"
         in
...
and _menhir_reduce20 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : 'tv_list_def_ = 
# 211 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( [] )
# 2563 "parser.ml"
     in
...
# 116 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( Some x )
# 2641 "parser.ml"
         in
    ...
    | CST _ | DEF | FOR | IDENT _ | IF | LP | LSQ | MINUS | NOT | PRINT | RETURN ->
        ...
        ((let _v : 'tv_option_NEWLINE_ = 
# 114 "/home/debian/.opam/system/lib/menhir/standard.mly"
    ( None )
# 2650 "parser.ml"
         in
